      ...
      <div className="relative flex items-center gap-6">
        ...
        <div className="relative">
          ...
          {filteredResults.length > 0 && (
            ...
            <div className="absolute mt-2 w-full overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl">
            ...
            <div className="absolute right-0 mt-3 w-96 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl">
              ...
              <div className="max-h-96 overflow-y-auto">
                ...
                {notifications.map((item) => (
                  ...
                  <div
                    key={item.id}
                    className="flex cursor-pointer items-start gap-4 border-b p-4 hover:bg-blue-50"
                  >
