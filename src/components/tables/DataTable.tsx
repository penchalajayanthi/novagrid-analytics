...
const DataTable = <T extends object>({
            ...
            <tr>
              {columns.map((column) => (
                <th
                  ...
                  className={`border-b px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-slate-500 ${column.sortable
  ...
  className="cursor-pointer border-b transition-all duration-200 hover:bg-blue-50"
>
                  {columns.map((column) => (
                    <td
                      key={String(column.key)}
